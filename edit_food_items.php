...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="edit_food_items.php" class="list-group-item active">Edit Category</a>
    		<a href="delete_food_items.php" class="list-group-item ">Delete Category</a>
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> EDIT CATEGORY HERE </h3>
