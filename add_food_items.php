...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="add_food_items.php" class="list-group-item active">Add Category</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> ADD NEW CATEGORY HERE </h3>
