...
<html>
  ...
  <head>
    <title> Manager Login | Pizza </title>
  </head>
...
<div class="container">
    <div class="jumbotron">
     <h1>Hello Manager! </h1>
     <p>Manage all Categories From Here</p>
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="view_food_items.php" class="list-group-item ">View Category</a>
    		<a href="add_food_items.php" class="list-group-item ">Add Category</a>
    		<a href="edit_food_items.php" class="list-group-item ">Edit Category</a>
    		<a href="delete_food_items.php" class="list-group-item active">Delete Category</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> DELETE YOUR CATEGORY HERE </h3>
